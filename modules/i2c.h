...
private:
  ...
  enum eI2CMacroState {
    ...
    eI2CAddress,         // In the process of transferring an address
    eI2CTransfer,        // In the prcoess of transferring a data byte
  ...
  /// writeOp - whether the current communication is reading (false) or
  /// writing (true) to a target device. This is a copy of the value of
  /// the mWriteOp attribute, taken at the start of the communication.
  /// This prevents protocol errors when the attribute is changed during
  /// the communication.
  bool writeOp;
  ...
  /// I2C Write Operation. Control the read/write bit for subsequent
  /// communications.
  Boolean *mWriteOp;
