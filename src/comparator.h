...
class ComparatorModule2 : public FVR_ATTACH, public DAC_ATTACH, public apfpin
{
public:
    ...
    void assign_sr_latch(SR_LATCH *_sr_latch) { sr_latch = _sr_latch; }
