/*
   Copyright (C) 2013,2014,2017,2020,2025 Roy R. Rankin
      ...
      sr_latch(this), dsm_module(this)
{
    ...
    tmr0.set_tmr0_cpu(this, m_porta, 4, option_reg);
    tmr0.start(0);
...
P12F1822::~P12F1822()
{
    ...
    remove_sfr_register(sr_latch.srcon0);
    remove_sfr_register(sr_latch.srcon1);
...
void P12F1822::create_sfr_map()
{
    ...
    sr_latch.srcon0 = new SRCON0(this, "srcon0", "SR Latch Control 0 Register", &sr_latch);
    sr_latch.srcon1 = new SRCON1(this, "srcon1", "SR Latch Control 1 Register", &sr_latch);
    add_sfr_register(sr_latch.srcon0, 0x11a, RegisterValue(0x00, 0));
    add_sfr_register(sr_latch.srcon1, 0x11b, RegisterValue(0x00, 0));
    ...
    comparator.assign_sr_latch(&sr_latch);
    ...
    sr_latch.setPins(&(*m_porta)[1], &(*m_porta)[2], &(*m_porta)[5]); // sri, srq, srnq
...
void P12F1822::create_iopin_map()
{
    ...
    package->assign_pin(7, m_porta->addPin(new IO_bi_directional_pu("porta0", Vth), 0));
    package->assign_pin(6, m_porta->addPin(new IO_bi_directional_pu("porta1", Vth), 1));
    package->assign_pin(5, m_porta->addPin(new IO_bi_directional_pu("porta2", Vth), 2));
    package->assign_pin(4, m_porta->addPin(new IO_bi_directional_pu("porta3", Vth), 3));
    package->assign_pin(3, m_porta->addPin(new IO_bi_directional_pu("porta4", Vth), 4));
    package->assign_pin(2, m_porta->addPin(new IO_bi_directional_pu("porta5", Vth), 5));
    package->assign_pin(1, 0);	// Vdd
    package->assign_pin(8, 0);	// Vss
    update_vdd();  // set logic levels for Vdd
}
...
Processor * P12LF1822::construct(const char *name)
{
    ...
    p->set_Vdd(3.3);		//set before create
...
void P16F1503::create_iopin_map()
{
    ...
    package->assign_pin(3, m_porta->addPin(new IO_bi_directional_pu("porta4", Vth), 4));
    package->assign_pin(4, m_porta->addPin(new IO_bi_directional_pu("porta3", Vth), 3));
    package->assign_pin(5, m_portc->addPin(new IO_bi_directional_pu("portc5", Vth), 5));
    package->assign_pin(6, m_portc->addPin(new IO_bi_directional_pu("portc4", Vth), 4));
    package->assign_pin(7, m_portc->addPin(new IO_bi_directional_pu("portc3", Vth), 3));
    package->assign_pin(8, m_portc->addPin(new IO_bi_directional_pu("portc2", Vth), 2));
    package->assign_pin(9, m_portc->addPin(new IO_bi_directional_pu("portc1", Vth), 1));
    package->assign_pin(10, m_portc->addPin(new IO_bi_directional_pu("portc0", Vth), 0));
    package->assign_pin(11, m_porta->addPin(new IO_bi_directional_pu("porta2", Vth), 2));
    package->assign_pin(12, m_porta->addPin(new IO_bi_directional_pu("porta1", Vth), 1));
    package->assign_pin(13, m_porta->addPin(new IO_bi_directional_pu("porta0", Vth), 0));
...
void P16F1503::create_sfr_map()
{
    ...
    clc1.set_tmr135(&tmr1l);
    clc2.set_tmr135(&tmr1l);
...
void  P16F1503::create(int /* ram_top */, int eeprom_size, int dev_id)
{
    create_iopin_map();
    osccon = new OSCCON_2(this, "osccon", "Oscillator Control Register");
    e = new EEPROM_EXTND(this, pir2);
      ...
      opa2con(this, "opa2con", "Operational Amplifier 2 Control Registers")
{
    ...
    tmr0.set_tmr0_cpu(this, nullptr,option_reg);
    //tmr0.set_tmr0_cpu(this, m_porta, 4, option_reg);
    tmr0.start(0);
    tmr0.set_t1gcon(&t1con_g.t1gcon);
    set_mclr_pin(4);
...
void  P16F1705::create(int /* ram_top */ , int eesize, int dev_id)
{
    create_iopin_map();
...
void  P16F1709::create(int /* ram_top */ , int ee_size, int dev_id)
{
    create_iopin_map();
...
void  P16F178x::create(int /* ram_top */, int eeprom_size, int dev_id)
{
    e = new EEPROM_EXTND(this, pir2);
    set_eeprom(e);
    osccon = new OSCCON_2(this, "osccon", "Oscillator Control Register");
...
void P16F1788::create_iopin_map()
{
    ...
    //createMCLRPin(1);
    // Now Create the package and place the I/O pins
    package->assign_pin(1, m_porte->addPin(new IO_bi_directional_pu("porte3", Vth), 3));
    package->assign_pin(2, m_porta->addPin(new IO_bi_directional_pu("porta0", Vth), 0));
    package->assign_pin(3, m_porta->addPin(new IO_bi_directional_pu("porta1", Vth), 1));
    package->assign_pin(4, m_porta->addPin(new IO_bi_directional_pu("porta2", Vth), 2));
    package->assign_pin(5, m_porta->addPin(new IO_bi_directional_pu("porta3", Vth), 3));
    package->assign_pin(6, m_porta->addPin(new IO_bi_directional_pu("porta4", Vth), 4));
    package->assign_pin(7, m_porta->addPin(new IO_bi_directional_pu("porta5", Vth), 5));
    package->assign_pin(10, m_porta->addPin(new IO_bi_directional_pu("porta6", Vth), 6));
    package->assign_pin(9, m_porta->addPin(new IO_bi_directional_pu("porta7", Vth), 7));
    package->assign_pin(11, m_portc->addPin(new IO_bi_directional_pu("portc0", Vth), 0));
    package->assign_pin(12, m_portc->addPin(new IO_bi_directional_pu("portc1", Vth), 1));
    package->assign_pin(13, m_portc->addPin(new IO_bi_directional_pu("portc2", Vth), 2));
    package->assign_pin(14, m_portc->addPin(new IO_bi_directional_pu("portc3", Vth), 3));
    package->assign_pin(15, m_portc->addPin(new IO_bi_directional_pu("portc4", Vth), 4));
    package->assign_pin(16, m_portc->addPin(new IO_bi_directional_pu("portc5", Vth), 5));
    package->assign_pin(17, m_portc->addPin(new IO_bi_directional_pu("portc6", Vth), 6));
    package->assign_pin(18, m_portc->addPin(new IO_bi_directional_pu("portc7", Vth), 7));
    package->assign_pin(21, m_portb->addPin(new IO_bi_directional_pu("portb0", Vth), 0));
    package->assign_pin(22, m_portb->addPin(new IO_bi_directional_pu("portb1", Vth), 1));
    package->assign_pin(23, m_portb->addPin(new IO_bi_directional_pu("portb2", Vth), 2));
    package->assign_pin(24, m_portb->addPin(new IO_bi_directional_pu("portb3", Vth), 3));
    package->assign_pin(25, m_portb->addPin(new IO_bi_directional_pu("portb4", Vth), 4));
    package->assign_pin(26, m_portb->addPin(new IO_bi_directional_pu("portb5", Vth), 5));
    package->assign_pin(27, m_portb->addPin(new IO_bi_directional_pu("portb6", Vth), 6));
    package->assign_pin(28, m_portb->addPin(new IO_bi_directional_pu("portb7", Vth), 7));
...
void  P16F1788::create(int ram_top, int eeprom_size, int dev_id)
{
    ram_size = ram_top;
    create_iopin_map();
    P16F178x::create(ram_top, eeprom_size, dev_id);
    create_sfr_map();
...
void P16F1823::create_sfr_map()
{
    ...
    sr_latch.srcon1->set_ValidBits(0xff);
    sr_latch.setPins(&(*m_porta)[1], &(*m_porta)[2], &(*m_portc)[4]);
}
...
P16F1847::P16F1847(const char *_name, const char *desc)
  : P12F1822(_name, desc),
    ...
    ssp2(this)
{
    m_iocbf = new IOCxF(this, "iocbf", "Interrupt-On-Change flag Register", 0xff);
    m_iocbp = new IOC(this, "iocbp", "Interrupt-On-Change positive edge", 0xff);
    m_iocbn = new IOC(this, "iocbn", "Interrupt-On-Change negative edge", 0xff);
    m_portb = new PicPortIOCRegister(this, "portb", "", intcon, m_iocbp, m_iocbn, m_iocbf, 8, 0xff);
    m_trisb = new PicTrisRegister(this, "trisb", "", m_portb, false, 0xff);
    m_latb = new PicLatchRegister(this, "latb", "", m_portb, 0xff);
    m_wpub = new WPU(this, "wpub", "Weak Pull-up Register", m_portb, 0xff);
    ...
    cpscon1.mValidBits = 0x0f;
    pir3 = new PIR(this, "pir3", "Peripheral Interrupt Register", intcon, &pie3, 0x3a);
    pir4 = new PIR(this, "pir4", "Peripheral Interrupt Register", intcon, &pie4, 0x03);
    pir2->valid_bits |= PIR2v1822::C2IF;
    pir2->writable_bits |= PIR2v1822::C2IF;
    pir3->valid_bits = pir3->writable_bits = 0x3a;
    pir4->valid_bits = pir4->writable_bits = 0x03;
}


P16F1847::~P16F1847()
{
    comparator.detach_DAC();
    delete_file_registers(0xc0, 0xef, 0x00);
    delete_file_registers(0x120, 0x16f, 0x00);
    delete_file_registers(0x1a0, 0x1ef, 0x00);
    delete_file_registers(0x220, 0x26f, 0x00);
    delete_file_registers(0x2a0, 0x2ef, 0x00);
    delete_file_registers(0x320, 0x36f, 0x00);
    delete_file_registers(0x3a0, 0x3ef, 0x00);
    delete_file_registers(0x420, 0x46f, 0x00);
    delete_file_registers(0x4a0, 0x4ef, 0x00);
    delete_file_registers(0x520, 0x56f, 0x00);
    delete_file_registers(0x5a0, 0x5ef, 0x00);
    delete_file_registers(0x620, 0x64f, 0x00);
...
void  P16F1847::create(int ram_top, int eeprom_size, int dev_id)
{
    create_iopin_map();
    e = new EEPROM_EXTND(this, pir2);
    set_eeprom(e);
    ...
    e->initialize(eeprom_size, 32, 32, 0x8000);
    e->set_intcon(intcon);
    e->get_reg_eecon1()->set_valid_bits(0xff);
    add_file_registers(0x20, ram_top, 0x00);
    create_sfr_map();
    dsm_module.setOUTpin(&(*m_portb)[3]);	// MDOUT
    dsm_module.setMINpin(&(*m_portb)[2]);	// MDMIN
    dsm_module.setCIN1pin(&(*m_portb)[7]);	// MDCIN1
    dsm_module.setCIN2pin(&(*m_portb)[4]);	// MDCIN2
...
void P16F1847::create_sfr_map()
{
    _14bit_e_processor::create_sfr_map();
    P12F1822::create_sfr_map();
    // This processor has apfcon0 instead of apfcon and ssp1 instead of ssp
    apfcon.new_name("apfcon0");
    // This processor lacks interrupt on change functionality on port A
    remove_sfr_register(m_iocap);
    remove_sfr_register(m_iocan);
    remove_sfr_register(m_iocaf);
    // m_porta->setTris(m_trisa);
    // Correct some register names
    get_eeprom()->get_reg_eeadr()->new_name("eeadrl");
    ssp.sspcon.new_name("ssp1con1");
    ...
    add_sfr_register(pir3, 0x013, RegisterValue(0, 0));
    add_sfr_register(&pie3, 0x093, RegisterValue(0, 0));
    add_sfr_register(pir4, 0x014, RegisterValue(0, 0));
    add_sfr_register(&pie4, 0x094, RegisterValue(0, 0));
    add_sfr_register(&apfcon1, 0x11e, RegisterValue(0, 0));
    add_sfr_register(&ccpr2l, 0x298, RegisterValue(0, 0));
    add_sfr_register(&ccpr2h, 0x299, RegisterValue(0, 0));
    add_sfr_registerR(&ccp2con, 0x29a, RegisterValue(0, 0));
    ...
    add_sfr_register(&ssp2.sspbuf, 0x219, RegisterValue(0, 0), "ssp2buf");
    add_sfr_register(&ssp2.sspadd, 0x21a, RegisterValue(0, 0), "ssp2add");
    add_sfr_register(ssp2.sspmsk, 0x21b, RegisterValue(0xff, 0), "ssp2msk");
    add_sfr_register(&ssp2.sspstat, 0x21c, RegisterValue(0, 0), "ssp2stat");
    add_sfr_register(&ssp2.sspcon, 0x21d, RegisterValue(0, 0), "ssp2con1");
    add_sfr_register(&ssp2.sspcon2, 0x21e, RegisterValue(0, 0), "ssp2con2");
    add_sfr_register(&ssp2.ssp1con3, 0x21f, RegisterValue(0, 0), "ssp2con3");
    ...
    m_trisa->value.put(0xff);
    m_trisa->setEnableMask(0xdf);
    m_trisa->por_value.put(0xff);
    m_lata->setEnableMask(0xdf);
    m_wpua->setValidBits(0x20);
    m_porta->setEnableMask(0xff);
    m_porta->setTris(m_trisa);
    add_sfr_register(m_latb, 0x10d);
    add_sfr_registerR(&anselb, 0x18d, RegisterValue(0xfe, 0));
    anselb.setAdcon1(&adcon1);
    add_sfr_registerR(m_iocbp, 0x394, RegisterValue(0,0), "iocbp");
    add_sfr_registerR(m_iocbn, 0x395, RegisterValue(0,0), "iocbn");
    add_sfr_registerR(m_iocbf, 0x396, RegisterValue(0,0), "iocbf");
    ...
    ansela.config(0x1f, 0);
    ansela.setValidBits(0x1f);
    ansela.value.put(0x1f);
    ansela.por_value.put(0x1f);
    anselb.config(0xfe, 5);
    anselb.setValidBits(0xfe);
    anselb.setAdcon1(&adcon1);
    ansela.setAnsel(&anselb);
    anselb.setAnsel(&ansela);
    ...
    // Pin values for default APFCON
    usart.setIOpin(&(*m_portb)[2], USART_MODULE::TX_PIN);
    usart.setIOpin(&(*m_portb)[1], USART_MODULE::RX_PIN);
    ccp1as.setIOpin(0, 0, &(*m_portb)[0]);      
    ccp1con.setBitMask(0xff);
    ccp1con.setIOpin(&(*m_portb)[3], &(*m_portb)[5], &(*m_portb)[6], &(*m_portb)[7]);
    ccp2as.setIOpin(0, 0, &(*m_portb)[0]);
    ccp2as.link_registers(&pwm2con, &ccp2con);
    ccp2con.setBitMask(0xff);
    ccp2con.setIOpin(&(*m_portb)[6], &(*m_portb)[7]);
    ccp2con.pstrcon = &pstr2con;
    ccp2con.pwm1con = &pwm2con;
    ccp2con.setCrosslinks(&ccpr2l, pir2, PIR2v1822::CCP2IF, &tmr2, &ccp2as);
    ccpr2l.ccprh = &ccpr2h;
    ...
    ccpr2h.ccprl = &ccpr2l;
    ccp3con.setCrosslinks(&ccpr3l, pir3, (1 << 4), 0, 0);
    ccp3con.setIOpin(&(*m_porta)[3]);
    ccpr3l.ccprh = &ccpr3h;
    ccpr3l.tmrl = &tmr1l;
    ccpr3h.ccprl = &ccpr3l;
    ccp4con.setCrosslinks(&ccpr4l, pir3, (1 << 5), 0, 0);
    ccp4con.setIOpin(&(*m_porta)[4]);
    ccpr4l.ccprh = &ccpr4h;
    ccpr4l.tmrl = &tmr1l;
    ccpr4h.ccprl = &ccpr4l;
    t4con.tmr2 = &tmr4;
    ...
    apfcon.set_pins(0, &ccp1con, CCPCON::CCP_PIN, &(*m_portb)[3], &(*m_portb)[0]); //CCP1/P1A
    apfcon.set_pins(1, &ccp1con, CCPCON::PxC_PIN, &(*m_portb)[6], &(*m_porta)[7]); //P1C
    apfcon.set_pins(2, &ccp1con, CCPCON::PxD_PIN, &(*m_portb)[7], &(*m_porta)[6]); //P1D
    apfcon.set_pins(3, &ccp2con, CCPCON::CCP_PIN, &(*m_portb)[6], &(*m_porta)[7]); //CCP2/P2A
    apfcon.set_pins(4, &ccp2con, CCPCON::PxB_PIN, &(*m_portb)[7], &(*m_porta)[6]); //P2B
    apfcon.set_pins(5, &ssp, SSP1_MODULE::SS_PIN, &(*m_portb)[5], &(*m_porta)[5]); //SSP SS1
    apfcon.set_pins(6, &ssp, SSP1_MODULE::SDO_PIN, &(*m_portb)[2], &(*m_porta)[6]); //SSP SDO1
    apfcon.set_pins(7, &usart, USART_MODULE::RX_PIN, &(*m_portb)[1], &(*m_portb)[2]); //USART RX Pin
    apfcon1.set_pins(0, &usart, USART_MODULE::TX_PIN, &(*m_portb)[2], &(*m_portb)[5]); //USART TX Pin

    comparator.cmxcon1[0]->set_INpinNeg(&(*m_porta)[0], &(*m_porta)[1],
                                        &(*m_porta)[2], &(*m_porta)[3]);
    comparator.cmxcon1[1]->set_INpinNeg(&(*m_porta)[0], &(*m_porta)[1],
                                        &(*m_porta)[2], &(*m_porta)[3]);
    comparator.cmxcon1[0]->set_INpinPos(&(*m_porta)[3]);
    comparator.cmxcon1[1]->set_INpinPos(&(*m_porta)[2]);
    comparator.cmxcon1[0]->set_OUTpin(&(*m_porta)[3], &(*m_porta)[4]);
    comparator.cmxcon1[1]->set_OUTpin(&(*m_porta)[4]);
    comparator.cmxcon0[0]->setBitMask(0xf7);
    comparator.cmxcon0[0]->setIntSrc(new InterruptSource(pir2, (1 << 5)));
    comparator.cmxcon0[1]->setBitMask(0xf7);
    comparator.cmxcon0[1]->setIntSrc(new InterruptSource(pir2, (1 << 6)));
    ...
    comparator.Pmask[2] = CMxCON1::CM_DAC1;
    comparator.Pmask[4] = CMxCON1::CM_FVR;
    // Not sure how to specify a different Pmask for comparator 2
    // The cm_inputPos (in comparator.h) array is too small anyway
    // comparator.Pmask[6] = CMxCON1::CM_PIN;  // Comparator 2 only
    comparator.attach_DAC(m_daccon0->get_node_dacout(), CMxCON1::CM_DAC1);
    cpscon0.set_pin(3, &(*m_porta)[3]);
    cpscon0.set_pin(4, &(*m_porta)[4]);
    cpscon0.set_pin(5, &(*m_portb)[6]);
    cpscon0.set_pin(6, &(*m_portb)[7]);
    cpscon0.set_pin(7, &(*m_portb)[5]);
    cpscon0.set_pin(8, &(*m_portb)[4]);
    cpscon0.set_pin(9, &(*m_portb)[3]);
    cpscon0.set_pin(10, &(*m_portb)[2]);
    cpscon0.set_pin(11, &(*m_portb)[1]);
    sr_latch.srcon1->set_ValidBits(0xff);
    sr_latch.setPins(&(*m_portb)[0], &(*m_porta)[3], &(*m_porta)[4]);
}
...
void P16F1847::create_iopin_map()
{
    ...
    // Now Create the package and place the I/O pins
    package->assign_pin(17, m_porta->addPin(new IO_bi_directional_pu("porta0", Vth), 0));
    package->assign_pin(18, m_porta->addPin(new IO_bi_directional_pu("porta1", Vth), 1));
    package->assign_pin(1, m_porta->addPin(new IO_bi_directional_pu("porta2", Vth), 2));
    package->assign_pin(2, m_porta->addPin(new IO_bi_directional_pu("porta3", Vth), 3));
    package->assign_pin(3, m_porta->addPin(new IO_bi_directional_pu("porta4", Vth), 4));
    package->assign_pin(4, m_porta->addPin(new IO_bi_directional_pu("porta5", Vth), 5));
    package->assign_pin(15, m_porta->addPin(new IO_bi_directional_pu("porta6", Vth), 6));
    package->assign_pin(16, m_porta->addPin(new IO_bi_directional_pu("porta7", Vth), 7));
    package->assign_pin(6, m_portb->addPin(new IO_bi_directional_pu("portb0", Vth), 0));
    package->assign_pin(7, m_portb->addPin(new IO_bi_directional_pu("portb1", Vth), 1));
    package->assign_pin(8, m_portb->addPin(new IO_bi_directional_pu("portb2", Vth), 2));
    package->assign_pin(9, m_portb->addPin(new IO_bi_directional_pu("portb3", Vth), 3));
    package->assign_pin(10, m_portb->addPin(new IO_bi_directional_pu("portb4", Vth), 4));
    package->assign_pin(11, m_portb->addPin(new IO_bi_directional_pu("portb5", Vth), 5));
    package->assign_pin(12, m_portb->addPin(new IO_bi_directional_pu("portb6", Vth), 6));
    package->assign_pin(13, m_portb->addPin(new IO_bi_directional_pu("portb7", Vth), 7));
...
void P16F1847::set_out_of_range_pm(unsigned int address, unsigned int value)
{
    if ((address >= 0xf000) && (address < 0xf000 + get_eeprom()->get_rom_size()))
    {
        get_eeprom()->change_rom(address - 0xf000, value);
    }
}


void P16F1847::oscillator_select(unsigned int cfg_word1, bool clkout)
{
...
//========================================================================
Processor * P16LF1847::construct(const char *name)
{
    P16LF1847 *p = new P16LF1847(name);
    p->set_Vdd(3.3);		//set before create
    p->create(0x7f, 256, 0x14a0);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
P16LF1847::P16LF1847(const char *_name, const char *desc) :
    P16F1847(_name, desc)
{
}
...
void  P16LF1847::create(int ram_top, int eeprom_size, int dev_id)
{
    P16F1847::create(ram_top, eeprom_size, dev_id);
}
//========================================================================

P16F193x::P16F193x(const char *_name, const char *desc)
  : _14bit_e_processor(_name, desc),
      ansela(this, "ansela", "Port A Analog Select"),
      anselb(this, "anselb", "Port B Analog Select"),
      comparator(this),
      pie1(this, "pie1", "Peripheral Interrupt Enable"),
      pie2(this, "pie2", "Peripheral Interrupt Enable"),
      pie3(this, "pie3", "Peripheral Interrupt Enable"),
      ...
      tmr1l(this, "tmr1l", "TMR1 Low"),
      tmr1h(this, "tmr1h", "TMR1 High"),
      ccp1con(this, "ccp1con", "Capture Compare Control 1"),
      ccpr1l(this, "ccpr1l", "Capture Compare 1 Low"),
      ccpr1h(this, "ccpr1h", "Capture Compare 1 High"),
      ccp2con(this, "ccp2con", "Capture Compare Control 2"),
      ccpr2l(this, "ccpr2l", "Capture Compare 2 Low"),
      ccpr2h(this, "ccpr2h", "Capture Compare 2 High"),
      ccp3con(this, "ccp3con", "Capture Compare Control 3"),
      ccpr3l(this, "ccpr3l", "Capture Compare 3 Low"),
      ccpr3h(this, "ccpr3h", "Capture Compare 3 High"),
      ccp4con(this, "ccp4con", "Capture Compare Control 4"),
      ccpr4l(this, "ccpr4l", "Capture Compare 4 Low"),
      ccpr4h(this, "ccpr4h", "Capture Compare 4 High"),
      ccp5con(this, "ccp5con", "Capture Compare Control 5"),
      ...
      usart(this),
      ssp(this),
      apfcon(this, "apfcon", "Alternate Pin Function Control Register", 0x7f),
      pwm1con(this, "pwm1con", "Enhanced PWM Control Register"),
      pwm2con(this, "pwm2con", "Enhanced PWM Control Register"),
      pwm3con(this, "pwm3con", "Enhanced PWM Control Register"),
      ccp1as(this, "ccp1as", "CCP1 Auto-Shutdown Control Register"),
      ccp2as(this, "ccp2as", "CCP2 Auto-Shutdown Control Register"),
      ccp3as(this, "ccp3as", "CCP3 Auto-Shutdown Control Register"),
      ccptmrs(this),
      pstr1con(this, "pstr1con", "Pulse Sterring Control Register"),
      pstr2con(this, "pstr2con", "Pulse Sterring Control Register"),
      pstr3con(this, "pstr3con", "Pulse Sterring Control Register"),
      cpscon0(this, "cpscon0", " Capacitive Sensing Control Register 0"),
      cpscon1(this, "cpscon1", " Capacitive Sensing Control Register 1"),
      sr_latch(this),
      lcd_module(this, true)
{
    ...
    m_iocbp = new IOC(this, "iocbp", "Interrupt-On-Change positive edge", 0xff);
    m_iocbn = new IOC(this, "iocbn", "Interrupt-On-Change negative edge", 0xff);
    m_portb = new PicPortIOCRegister(this, "portb", "", intcon, m_iocbp, 
		    m_iocbn, m_iocbf, 8, 0xff);
    m_wpub = new WPU(this, "wpub", "Weak Pull-up Register", m_portb, 0xff);
    m_trisb = new PicTrisRegister(this, "trisb", "", m_portb, false, 0xff);
    m_latb  = new PicLatchRegister(this, "latb", "", m_portb, 0xff);
    ...
    m_late  = new PicLatchRegister(this, "late", "", m_porte, 0x04);
    m_wpue = new WPU(this, "wpue", "Weak Pull-up Register", m_porte, 0x08);
    ...
    pir1->valid_bits = 0xff;
    pir1->writable_bits = 0xcf;
    pir2->valid_bits = pir2->writable_bits = 0xfd;
    pir3->valid_bits = pir3->writable_bits = 0x7a;
    tmr1l.tmrh = &tmr1h;
    tmr1l.t1con = &t1con_g;
    tmr1l.setInterruptSource(new InterruptSource(pir1, PIR1v1::TMR1IF));
    tmr1h.tmrl  = &tmr1l;
    ...
    comparator.cmxcon0[1] = new CMxCON0(this, "cm2con0", " Comparator C2 Control Register 0", 1, &comparator);
    comparator.cmxcon1[1] = new CMxCON1(this, "cm2con1", " Comparator C2 Control Register 1", 1, &comparator);
    m_daccon0 = new DACCON0(this, "daccon0", "DAC Voltage reference register 0", 0xed, 32);
    m_daccon1 = new DACCON1(this, "daccon1", "DAC Voltage reference register 1", 0x1f, m_daccon0);
    osccon = new OSCCON_2(this, "osccon", "Oscillator Control Register");
    set_mclr_pin(1);
}
...
P16F193x::~P16F193x()
{
    ...
    remove_sfr_register(&borcon);
    remove_sfr_register(&fvrcon);
    remove_sfr_register(m_daccon0);
    remove_sfr_register(m_daccon1);
    remove_sfr_register(sr_latch.srcon0);
    remove_sfr_register(sr_latch.srcon1);
    remove_sfr_register(&apfcon);
    remove_sfr_register(&ansela);
    ...
    remove_sfr_register(&t6con);
    remove_sfr_register(&ccp1as);
    remove_sfr_register(lcd_module.lcdcst);
    remove_sfr_register(lcd_module.lcdref);
    remove_sfr_register(lcd_module.lcdrl);
    remove_sfr_register(lcd_module.lcdcon);
    remove_sfr_register(lcd_module.lcdps);
    remove_sfr_register(lcd_module.lcdSEn[0]);
    remove_sfr_register(lcd_module.lcdSEn[1]);
    remove_sfr_register(lcd_module.lcddatax[0]);
    remove_sfr_register(lcd_module.lcddatax[1]);
    remove_sfr_register(lcd_module.lcddatax[3]);
    remove_sfr_register(lcd_module.lcddatax[4]);
    remove_sfr_register(lcd_module.lcddatax[6]);
    remove_sfr_register(lcd_module.lcddatax[7]);
    remove_sfr_register(lcd_module.lcddatax[9]);
    remove_sfr_register(lcd_module.lcddatax[10]);
    ...
    remove_sfr_register(osccon);
    remove_sfr_register(&oscstat);
    remove_sfr_register(m_iocbp);
    remove_sfr_register(m_iocbn);
    remove_sfr_register(m_iocbf);
    remove_sfr_register(comparator.cmxcon0[0]);
    remove_sfr_register(comparator.cmxcon1[0]);
    remove_sfr_register(comparator.cmxcon0[1]);
    remove_sfr_register(comparator.cmxcon1[1]);
...
void P16F193x::option_new_bits_6_7(unsigned int bits)
{
    Dprintf(("P16F193x::option_new_bits_6_7 bits=%x\n", bits));
    m_portb->setIntEdge((bits & OPTION_REG::BIT6) == OPTION_REG::BIT6);
    m_wpub->set_wpu_pu((bits & OPTION_REG::BIT7) != OPTION_REG::BIT7);
    //m_wpue->set_wpu_pu((bits & OPTION_REG::BIT7) != OPTION_REG::BIT7);
}


void P16F193x::create_sfr_map()
{
    _14bit_e_processor::create_sfr_map();
    pir_set_2_def.set_pir1(pir1);
    pir_set_2_def.set_pir2(pir2);
    ...
    usart.initialize(pir1,
                     ...
                     new _RCREG(this, "rcreg", "USART Receiver Register", &usart));
    // Bank 3
    add_sfr_register(&ansela,      0x18c, RegisterValue(0x3f, 0));
    add_sfr_register(&anselb,      0x18d, RegisterValue(0x3f, 0));
    add_sfr_register(get_eeprom()->get_reg_eeadr(),   0x191);
    add_sfr_register(get_eeprom()->get_reg_eeadrh(),   0x192);
    get_eeprom()->get_reg_eedata()->new_name("eedatl");
    get_eeprom()->get_reg_eedatah()->new_name("eedath");
    ...
    // Bank 4
    add_sfr_register(m_wpub,       0x20d, RegisterValue(0xff, 0), "wpub");
    add_sfr_register(&ssp.sspbuf,  0x211, RegisterValue(0, 0), "sspbuf");
    add_sfr_register(&ssp.sspadd,  0x212, RegisterValue(0, 0), "sspadd");
    add_sfr_register(ssp.sspmsk,   0x213, RegisterValue(0xff, 0), "sspmsk");
    add_sfr_register(&ssp.sspstat, 0x214, RegisterValue(0, 0), "sspstat");
    add_sfr_register(&ssp.sspcon,  0x215, RegisterValue(0, 0), "sspcon");
    add_sfr_register(&ssp.sspcon2, 0x216, RegisterValue(0, 0), "sspcon2");
    add_sfr_register(&ssp.ssp1con3, 0x217, RegisterValue(0, 0), "sspcon3");
    // Bank 5
    add_sfr_register(&ccpr1l,      0x291, RegisterValue(0, 0));
    add_sfr_register(&ccpr1h,      0x292, RegisterValue(0, 0));
    add_sfr_register(&ccp1con,     0x293, RegisterValue(0, 0));
    ...
    add_sfr_register(&ccpr2l,      0x298, RegisterValue(0, 0));
    add_sfr_register(&ccpr2h,      0x299, RegisterValue(0, 0));
    add_sfr_register(&ccp2con,     0x29a, RegisterValue(0, 0));
    add_sfr_register(&pwm2con, 	   0x29b, RegisterValue(0, 0));
    add_sfr_register(&ccp2as,      0x29c, RegisterValue(0, 0));
    add_sfr_register(&pstr2con,    0x29d, RegisterValue(1, 0));
    add_sfr_registerR(&ccptmrs.ccptmrs0, 0x29e, RegisterValue(0, 0), "ccptmrs0");
    add_sfr_registerR(&ccptmrs.ccptmrs1, 0x29f, RegisterValue(0, 0), "ccptmrs1");
    // Bank 6
    add_sfr_register(&ccpr3l,      0x311, RegisterValue(0, 0));
    add_sfr_register(&ccpr3h,      0x312, RegisterValue(0, 0));
    add_sfr_register(&ccp3con,     0x313, RegisterValue(0, 0));
    add_sfr_register(&pwm3con, 	   0x314, RegisterValue(0, 0));
    add_sfr_register(&ccp3as,      0x315, RegisterValue(0, 0));
    add_sfr_register(&pstr3con,    0x316, RegisterValue(1, 0));
    add_sfr_register(&ccpr4l,      0x318, RegisterValue(0, 0));
    add_sfr_register(&ccpr4h,      0x319, RegisterValue(0, 0));
    add_sfr_register(&ccp4con,     0x31a, RegisterValue(0, 0));
    add_sfr_register(&ccpr5l,      0x31c, RegisterValue(0, 0));
    add_sfr_register(&ccpr5h,      0x31d, RegisterValue(0, 0));
    add_sfr_register(&ccp5con,     0x31e, RegisterValue(0, 0));
    // Bank 7
    add_sfr_registerR(m_iocbp,     0x394, RegisterValue(0,0), "iocbp");
    add_sfr_registerR(m_iocbn,     0x395, RegisterValue(0,0), "iocbn");
    add_sfr_registerR(m_iocbf,     0x396, RegisterValue(0,0), "iocbf");
    ...
    // Bank 15
    add_sfr_register(lcd_module.lcdcon, 0x791, RegisterValue(0x03, 0));
    lcd_module.lcdcon->mask_writeable = 0xcf;
    add_sfr_register(lcd_module.lcdps, 0x792, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcdref, 0x793, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcdcst, 0x794, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcdrl, 0x795, RegisterValue(0x0, 0));


    add_sfr_register(lcd_module.lcdSEn[0], 0x798, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcdSEn[1], 0x799, RegisterValue(0x0, 0));

    add_sfr_register(lcd_module.lcddatax[0], 0x7A0, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcddatax[1], 0x7A1, RegisterValue(0x0, 0));

    add_sfr_register(lcd_module.lcddatax[3], 0x7A3, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcddatax[4], 0x7A4, RegisterValue(0x0, 0));

    add_sfr_register(lcd_module.lcddatax[6], 0x7A6, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcddatax[7], 0x7A7, RegisterValue(0x0, 0));

    add_sfr_register(lcd_module.lcddatax[9], 0x7A9, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcddatax[10], 0x7AA, RegisterValue(0x0, 0));

    lcd_module.set_Vlcd(&(*m_portb)[1], &(*m_portb)[2], &(*m_portb)[3]);
    lcd_module.set_LCDcom(&(*m_portb)[4], &(*m_portb)[5], 
		         nullptr,      &(*m_porta)[3]);
    lcd_module.set_LCDsegn(0, &(*m_portb)[0], &(*m_porta)[6],
                         &(*m_porta)[7], &(*m_portc)[2]);
    ...
    lcd_module.setIntSrc(new InterruptSource(pir2, (1 << 2)));
    lcd_module.set_t1con((T1CON *)&t1con_g);
    ...
    t1con_g.t1gcon.set_tmrl(&tmr1l);
    t1con_g.t1gcon.setInterruptSource(new InterruptSource(pir1, PIR1v1822::TMR1GIF));
    t1con_g.t1gcon.setGatepin(&(*m_portb)[5]);
    usart.mk_txif_int(pir1, (1<<4));
    usart.mk_rcif_int(pir1, (1<<5));
    usart.set_eusart(true);
    tmr2.ssp_module[0] = &ssp;
    ...
    ccp2as.setIOpin(0, 0, &(*m_portb)[0]);
    ccp2as.link_registers(&pwm2con, &ccp2con);
    ccp2as.set_c12_low(true);
    ccp2con.setIOpin(&(*m_portc)[1], &(*m_portc)[0]);
    ccp2con.pstrcon = &pstr2con;
    ccp2con.pwm1con = &pwm2con;
    ccp2con.setCrosslinks(&ccpr2l, pir2, PIR2v1822::CCP2IF, &tmr2, &ccp2as);
    ccpr2l.ccprh  = &ccpr2h;
    ccpr2l.tmrl   = &tmr1l;
    ccpr2h.ccprl  = &ccpr2l;
    ccp3as.setIOpin(0, 0, &(*m_portb)[0]);
    ccp3as.link_registers(&pwm3con, &ccp3con);
    ccp3as.set_c12_low(true);
    ccp3con.setIOpin(&(*m_portc)[6], &(*m_portc)[7]);
    ccp3con.pstrcon = &pstr3con;
    ccp3con.pwm1con = &pwm3con;
    ccp3con.setCrosslinks(&ccpr3l, pir3, PIR3v178x::CCP3IF, &tmr2, &ccp3as);
    ccpr3l.ccprh  = &ccpr3h;
    ccpr3l.tmrl   = &tmr1l;
    ccpr3h.ccprl  = &ccpr3l;
    ansela.config(0x3f, 0);
    ansela.setValidBits(0x3f);
    ansela.setAdcon1(&adcon1, m_porta);
    ansela.setAnsel(&anselb);
    anselb.config(0x3f, 8);
    anselb.setValidBits(0x3f);
    anselb.setAdcon1(&adcon1, m_portb);
    anselb.setAnsel(&ansela);
    ...
    adcon1.set_FVR_chan(0x1f);
    adcon1.setAdcon0(&adcon0);
    adcon1.attach_ad_fvr(fvrcon.get_node_adcvref(), 31);
    adcon1.attach_DAC(m_daccon0->get_node_dacout(), 30, 1);
    adcon1.setNumberOfChannels(32); // not all channels are used
    adcon1.setIOPin(0, &(*m_porta)[0]);
    adcon1.setIOPin(1, &(*m_porta)[1]);
    adcon1.setIOPin(2, &(*m_porta)[2]);
    ...
    cpscon0.attach_cda_fvr(fvrcon.get_node_cvref());
    cpscon0.attach_DAC(m_daccon0->get_node_dacout(), 99);
    cpscon0.mValidBits = 0x1F;
    cpscon1.mValidBits = 0x7;
    cpscon0.set_pin(0, &(*m_portb)[0]);
    cpscon0.set_pin(1, &(*m_portb)[1]);
    cpscon0.set_pin(2, &(*m_portb)[2]);
    cpscon0.set_pin(3, &(*m_portb)[3]);
    cpscon0.set_pin(4, &(*m_portb)[4]);
    cpscon0.set_pin(5, &(*m_portb)[5]);
    cpscon0.set_pin(6, &(*m_porta)[4]);
    cpscon0.set_pin(7, &(*m_porta)[5]);
    osccon->set_osctune(&osctune);
    osccon->set_oscstat(&oscstat);
    osctune.set_osccon((OSCCON *)osccon);
    osccon->write_mask = 0xfb;
    ...
    // Pin values for default APFCON
    ccp1as.setIOpin(0, 0, &(*m_portb)[0]);      
    comparator.eccpas[0] = &ccp1as;
    ccp1con.setBitMask(0xff);
    ccp1con.setIOpin(&(*m_portb)[3], &(*m_portb)[5], &(*m_portb)[6], &(*m_portb)[7]);
    ccp2as.setIOpin(0, 0, &(*m_portb)[0]);
    comparator.eccpas[1] = &ccp2as;
    ccp2as.link_registers(&pwm2con, &ccp2con);
    ccp2con.setBitMask(0xff);
    ccp2con.setIOpin(&(*m_portb)[6], &(*m_portb)[7]);
    ccp2con.pstrcon = &pstr2con;
    ...
    ccpr4l.tmrl = &tmr1l;
    ccpr4h.ccprl = &ccpr4l;
    ccp5con.setCrosslinks(&ccpr4l, pir3, (1 << 6), 0, 0);
    ...
    apfcon.set_pins(0, &ccp2con, CCPCON::CCP_PIN, &(*m_portc)[1], &(*m_portb)[3]); //CCP2/P2A
    apfcon.set_pins(1, &ssp, SSP1_MODULE::SS_PIN, &(*m_porta)[5], &(*m_porta)[0]); //SSP SS1
    apfcon.set_pins(2, &comparator, 1, &(*m_porta)[5], &(*m_porta)[0]); //C2OUT
    apfcon.set_pins(3, &sr_latch, SR_LATCH::SRNQ_PIN, &(*m_porta)[5], &(*m_porta)[0]); //SRNQ
    apfcon.set_pins(4, &ccp2con, CCPCON::PxB_PIN, &(*m_portc)[0], &(*m_portb)[5]); //CCP2/P2B
    apfcon.set_pins(5, &t1con_g.t1gcon, 0, &(*m_portb)[5], &(*m_portc)[4]); //tmr1 gate
    apfcon.set_pins(6, &ccp3con, CCPCON::CCP_PIN, &(*m_portc)[6], &(*m_portb)[5]); //P3A

    sr_latch.srcon1->set_ValidBits(0xff);
    sr_latch.setPins(&(*m_portb)[0], &(*m_porta)[4], &(*m_porta)[5]);
}



void P16F193x::set_out_of_range_pm(unsigned int address, unsigned int value)
{
    if ((address >= 0xf000) && (address < 0xf000 + get_eeprom()->get_rom_size()))
    {
        get_eeprom()->change_rom(address - 0xf000, value);
    ...
    {
	fprintf(stderr, "set_out_of_range_pm unknown address 0x%x\n", address);
	assert(0);
    }
}


void P16F193x::program_memory_wp(unsigned int mode)
{
    switch(mode)
    {
    case 3:	// no write protect
...
void P16F193x::oscillator_select(unsigned int cfg_word1, bool clkout)
{
    unsigned int mask = 0xff;
    unsigned int fosc = cfg_word1 & (FOSC0 | FOSC1 | FOSC2);
    osccon->set_config_irc(fosc == 4);
...
//========================================================================
Processor * P16F1933::construct(const char *name)
{
    P16F1933 *p = new P16F1933(name);
    p->create(0x7f, 256, 0x2320);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
P16F1933::P16F1933(const char *_name, const char *desc)
  : P16F193x(_name, desc)
{
}
...
void P16F1933::option_new_bits_6_7(unsigned int bits)
{
    m_portb->setIntEdge((bits & OPTION_REG::BIT6) == OPTION_REG::BIT6);
    m_wpub->set_wpu_pu((bits & OPTION_REG::BIT7) != OPTION_REG::BIT7);
    //m_wpue->set_wpu_pu((bits & OPTION_REG::BIT7) != OPTION_REG::BIT7);
...
void  P16F1933::create(int ram_top, int eeprom_size, int dev_id)
{
    create_iopin_map();
    e = new EEPROM_EXTND(this, pir2);
    set_eeprom(e);
...
void P16F1933::create_sfr_map()
{
    P16F193x::create_sfr_map();
}

void P16F1933::create_iopin_map()
{
    double Vth = get_Vdd();
    package = new Package(28);
    // Now Create the package and place the I/O pins
    package->assign_pin(1, m_porte->addPin(new IO_bi_directional("porte3", Vth), 3));
    package->assign_pin(2, m_porta->addPin(new IO_bi_directional("porta0", Vth), 0));
    package->assign_pin(3, m_porta->addPin(new IO_bi_directional("porta1", Vth), 1));
    package->assign_pin(4, m_porta->addPin(new IO_bi_directional("porta2", Vth), 2));
    package->assign_pin(5, m_porta->addPin(new IO_bi_directional("porta3", Vth), 3));
    package->assign_pin(6, m_porta->addPin(new IO_bi_directional("porta4", Vth), 4));
    package->assign_pin(7, m_porta->addPin(new IO_bi_directional("porta5", Vth), 5));
    package->assign_pin(10, m_porta->addPin(new IO_bi_directional("porta6", Vth), 6));
    package->assign_pin(9, m_porta->addPin(new IO_bi_directional("porta7", Vth), 7));
    package->assign_pin(21, m_portb->addPin(new IO_bi_directional_pu("portb0", Vth), 0));
    package->assign_pin(22, m_portb->addPin(new IO_bi_directional_pu("portb1", Vth), 1));
    package->assign_pin(23, m_portb->addPin(new IO_bi_directional_pu("portb2", Vth), 2));
    package->assign_pin(24, m_portb->addPin(new IO_bi_directional_pu("portb3", Vth), 3));
    ...
    package->assign_pin(27, m_portb->addPin(new IO_bi_directional_pu("portb6", Vth), 6));
    package->assign_pin(28, m_portb->addPin(new IO_bi_directional_pu("portb7", Vth), 7));
    package->assign_pin(11, m_portc->addPin(new IO_bi_directional("portc0", Vth), 0));
    package->assign_pin(12, m_portc->addPin(new IO_bi_directional("portc1", Vth), 1));
    package->assign_pin(13, m_portc->addPin(new IO_bi_directional("portc2", Vth), 2));
    package->assign_pin(14, m_portc->addPin(new IO_bi_directional("portc3", Vth), 3));
    package->assign_pin(15, m_portc->addPin(new IO_bi_directional("portc4", Vth), 4));
    package->assign_pin(16, m_portc->addPin(new IO_bi_directional("portc5", Vth), 5));
    package->assign_pin(17, m_portc->addPin(new IO_bi_directional("portc6", Vth), 6));
    package->assign_pin(18, m_portc->addPin(new IO_bi_directional("portc7", Vth), 7));
    package->assign_pin(20, 0); // Vdd
    package->assign_pin(8, 0); // Vss
    package->assign_pin(19, 0); // Vss
    update_vdd();  // set logic levels for Vdd
...
P16LF1933::P16LF1933(const char *_name, const char *desc)
    : P16F1933(_name, desc)
{
}
...
Processor * P16LF1933::construct(const char *name)
{
    P16LF1933 *p = new P16LF1933(name);
    p->set_Vdd(3.3);		//set before create
    p->create(0x7f, 256, 0x2420);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
void  P16LF1933::create(int ram_top, int eeprom_size, int dev_id)
{
    P16F1933::create(ram_top, eeprom_size, dev_id);
}

//========================================================================
// 40 Pin Version of P16F1933
Processor * P16F1934::construct(const char *name)
{
    P16F1934 *p = new P16F1934(name);
    p->create(0x7f, 256, 0x2340);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
P16F1934::P16F1934(const char *_name, const char *desc)
  : P16F1933(_name, desc),
    anseld(this, "anseld", "Port D Analog Select"),
    ansele(this, "ansele", "Port E Analog Select")
{
    m_portd = new PicPortRegister(this,"portd","", 8, 0xff);
    m_trisd = new PicTrisRegister(this, "trisd", "", m_portd, false, 0xff);
    m_latd  = new PicLatchRegister(this, "latd", "", m_portd, 0xff);
}


P16F1934::~P16F1934()
{
    remove_sfr_register(m_wpue);
    delete_sfr_register(m_portd);
    delete_sfr_register(m_trisd);
    delete_sfr_register(m_latd);
    remove_sfr_register(&anseld);
    remove_sfr_register(&ansele);
    remove_sfr_register(lcd_module.lcdSEn[2]);
    remove_sfr_register(lcd_module.lcddatax[2]);
    remove_sfr_register(lcd_module.lcddatax[5]);
    remove_sfr_register(lcd_module.lcddatax[8]);
    remove_sfr_register(lcd_module.lcddatax[11]);
}


void P16F1934::option_new_bits_6_7(unsigned int bits)
{
    m_portb->setIntEdge((bits & OPTION_REG::BIT6) == OPTION_REG::BIT6);
    m_wpub->set_wpu_pu((bits & OPTION_REG::BIT7) != OPTION_REG::BIT7);
    m_wpue->set_wpu_pu((bits & OPTION_REG::BIT7) != OPTION_REG::BIT7);
...
void  P16F1934::create(int ram_top, int eeprom_size, int dev_id)
{
    create_iopin_map();
    e = new EEPROM_EXTND(this, pir2);
    set_eeprom(e);
...
void P16F1934::create_sfr_map()
{
    P16F193x::create_sfr_map();
    add_sfr_register(m_portd, 0x0f);
    add_sfr_register(m_trisd, 0x8f, RegisterValue(0xff, 0));
    add_sfr_register(&anseld,   0x18f, RegisterValue(0xff, 0));
    add_sfr_register(&ansele,   0x190, RegisterValue(0x07, 0));
    add_sfr_register(m_latd,    0x10f);
    add_sfr_register(m_wpue, 0x210, RegisterValue(0x08, 0), "wpue");
    add_sfr_register(lcd_module.lcdSEn[2], 0x79A, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcddatax[2], 0x7A2, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcddatax[5], 0x7A5, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcddatax[8], 0x7A8, RegisterValue(0x0, 0));
    add_sfr_register(lcd_module.lcddatax[11], 0x7AB, RegisterValue(0x0, 0));
    lcd_module.set_LCDcom(&(*m_portb)[4], &(*m_portb)[5], 
		         &(*m_porta)[2],  &(*m_porta)[3]);
    ...
    ansela.setAnsel(&anseld);
    ansela.setAnsel(&ansele);
    anselb.setAnsel(&anseld);
    anselb.setAnsel(&ansele);
    anseld.config(0xff, 20);
    anseld.setValidBits(0xff);
    anseld.setAdcon1(&adcon1, m_portd);
    anseld.setAnsel(&ansela);
    anseld.setAnsel(&anselb);
    anseld.setAnsel(&ansele);
    ansele.config(0x07, 5);
    ansele.setValidBits(0x07);
    ansele.setAdcon1(&adcon1, m_porte);
    ansele.setAnsel(&ansela);
    ansele.setAnsel(&anselb);
    ansele.setAnsel(&anseld);
    apfcon.set_pins(4, &ccp2con, CCPCON::PxB_PIN, &(*m_portc)[0], &(*m_portd)[2]); //CCP2/P2B
    apfcon.set_pins(6, &ccp3con, CCPCON::CCP_PIN, &(*m_porte)[0], &(*m_portb)[5]); //P3A
    ccp1con.setIOpin(&(*m_portc)[2], &(*m_portd)[5],&(*m_portd)[6], &(*m_portd)[7]);
    ccp2con.setIOpin(&(*m_portc)[1], &(*m_portc)[0]);
    ccp3con.setIOpin(&(*m_porte)[0], &(*m_portc)[7]);
    cpscon0.set_pin(8, &(*m_portd)[0]);
    cpscon0.set_pin(9, &(*m_portd)[1]);
    cpscon0.set_pin(10, &(*m_portd)[2]);
    cpscon0.set_pin(11, &(*m_portd)[3]);
    cpscon0.set_pin(12, &(*m_portd)[4]);
    cpscon0.set_pin(13, &(*m_portd)[5]);
    cpscon0.set_pin(14, &(*m_portd)[6]);
    cpscon0.set_pin(15, &(*m_portd)[7]);
    cpscon1.mValidBits = 0x0f;
    cpscon0.mValidBits = 0x1F;
}

void P16F1934::create_iopin_map()
{
    double Vth = get_Vdd();
    ...
    package->assign_pin(6, m_porta->addPin(new IO_bi_directional("porta4", Vth), 4));
    package->assign_pin(7, m_porta->addPin(new IO_bi_directional("porta5", Vth), 5));
    package->assign_pin(14, m_porta->addPin(new IO_bi_directional("porta6", Vth), 6));
    package->assign_pin(13, m_porta->addPin(new IO_bi_directional("porta7", Vth), 7));
    package->assign_pin(33, m_portb->addPin(new IO_bi_directional_pu("portb0", Vth), 0));
    package->assign_pin(34, m_portb->addPin(new IO_bi_directional_pu("portb1", Vth), 1));
    package->assign_pin(35, m_portb->addPin(new IO_bi_directional_pu("portb2", Vth), 2));
    package->assign_pin(36, m_portb->addPin(new IO_bi_directional_pu("portb3", Vth), 3));
    package->assign_pin(37, m_portb->addPin(new IO_bi_directional_pu("portb4", Vth), 4));
    package->assign_pin(38, m_portb->addPin(new IO_bi_directional_pu("portb5", Vth), 5));
    package->assign_pin(39, m_portb->addPin(new IO_bi_directional_pu("portb6", Vth), 6));
    package->assign_pin(40, m_portb->addPin(new IO_bi_directional_pu("portb7", Vth), 7));
    package->assign_pin(15, m_portc->addPin(new IO_bi_directional("portc0", Vth), 0));
    package->assign_pin(16, m_portc->addPin(new IO_bi_directional("portc1", Vth), 1));
    package->assign_pin(17, m_portc->addPin(new IO_bi_directional("portc2", Vth), 2));
    package->assign_pin(18, m_portc->addPin(new IO_bi_directional("portc3", Vth), 3));
    package->assign_pin(23, m_portc->addPin(new IO_bi_directional("portc4", Vth), 4));
    package->assign_pin(24, m_portc->addPin(new IO_bi_directional("portc5", Vth), 5));
    package->assign_pin(25, m_portc->addPin(new IO_bi_directional("portc6", Vth), 6));
    package->assign_pin(26, m_portc->addPin(new IO_bi_directional("portc7", Vth), 7));
    package->assign_pin(19, m_portd->addPin(new IO_bi_directional("portd0", Vth), 0));
    package->assign_pin(20, m_portd->addPin(new IO_bi_directional("portd1", Vth), 1));
    package->assign_pin(21, m_portd->addPin(new IO_bi_directional("portd2", Vth), 2));
    package->assign_pin(22, m_portd->addPin(new IO_bi_directional("portd3", Vth), 3));
    package->assign_pin(27, m_portd->addPin(new IO_bi_directional("portd4", Vth), 4));
    package->assign_pin(28, m_portd->addPin(new IO_bi_directional("portd5", Vth), 5));
    package->assign_pin(29, m_portd->addPin(new IO_bi_directional("portd6", Vth), 6));
    package->assign_pin(30, m_portd->addPin(new IO_bi_directional("portd7", Vth), 7));
    package->assign_pin(8, m_porte->addPin(new IO_bi_directional("porte0", Vth), 0));
    package->assign_pin(9, m_porte->addPin(new IO_bi_directional("porte1", Vth), 1));
    package->assign_pin(10, m_porte->addPin(new IO_bi_directional("porte2", Vth), 2));
    package->assign_pin(1, m_porte->addPin(new IO_bi_directional("porte3", Vth), 3));
...
P16LF1934::P16LF1934(const char *_name, const char *desc)
    : P16F1934(_name, desc)
{
}
...
Processor * P16LF1934::construct(const char *name)
{
    P16LF1934 *p = new P16LF1934(name);
    p->set_Vdd(3.3);		//set before create
    p->create(0x7f, 256, 0x2440);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
void  P16LF1934::create(int ram_top, int eeprom_size, int dev_id)
{
    P16F1934::create(ram_top, eeprom_size, dev_id);
}

//========================================================================
P16F1936::P16F1936(const char *_name, const char *desc)
    : P16F1933(_name, desc)
{
}
...
Processor * P16F1936::construct(const char *name)
{
    P16F1936 *p = new P16F1936(name);
    p->create(0x7f, 256, 0x2360);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
void  P16F1936::create(int ram_top, int eeprom_size, int dev_id)
{
    P16F1933::create(ram_top, eeprom_size, dev_id);
}
P16LF1936::P16LF1936(const char *_name, const char *desc)
    : P16F1936(_name, desc)
{
}
...
Processor * P16LF1936::construct(const char *name)
{
    P16LF1936 *p = new P16LF1936(name);
    p->set_Vdd(3.3);		//set before create
    p->create(0x7f, 256, 0x2460);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
void  P16LF1936::create(int ram_top, int eeprom_size, int dev_id)
{
    P16F1936::create(ram_top, eeprom_size, dev_id);
}

//========================================================================
// Like P16F1934 but with more program memory and ram
Processor * P16F1937::construct(const char *name)
{
    P16F1937 *p = new P16F1937(name);
    p->create(0x7f, 256, 0x2380);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
P16F1937::P16F1937(const char *_name, const char *desc)
  : P16F1934(_name, desc)
{
}
...
void  P16F1937::create(int ram_top, int eeprom_size, int dev_id)
{
...
P16LF1937::P16LF1937(const char *_name, const char *desc)
    : P16F1937(_name, desc)
{
}
...
Processor * P16LF1937::construct(const char *name)
{
    P16LF1937 *p = new P16LF1937(name);
    p->set_Vdd(3.3);		//set before create
    p->create(0x7f, 256, 0x2480);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
void  P16LF1937::create(int ram_top, int eeprom_size, int dev_id)
{
    P16F1937::create(ram_top, eeprom_size, dev_id);
}

//========================================================================
// Like p16f1933 but more memory ran ram
P16F1938::P16F1938(const char *_name, const char *desc)
    : P16F1933(_name, desc)
{
}
...
P16F1938::~P16F1938()
{
    ...
    delete_file_registers(0x2a0, 0x2ef);
    delete_file_registers(0x320, 0x32f);
    delete_file_registers(0x330, 0x36f);
    delete_file_registers(0x3a0, 0x3ef);
    ...
    delete_file_registers(0x620, 0x64f);
}


Processor * P16F1938::construct(const char *name)
{
    P16F1938 *p = new P16F1938(name);
    p->create(0x7f, 256, 0x23A0);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
void  P16F1938::create(int ram_top, int eeprom_size, int dev_id)
{
    P16F1933::create(ram_top, eeprom_size, dev_id);
    add_file_registers(0x1a0, 0x1ef, 0x00);
    add_file_registers(0x220, 0x26f, 0x00);
    add_file_registers(0x2a0, 0x2ef, 0x00);
    add_file_registers(0x320, 0x32f, 0x00);
    add_file_registers(0x330, 0x36f, 0x00);
    add_file_registers(0x3a0, 0x3ef, 0x00);
    add_file_registers(0x420, 0x46f, 0x00);
    add_file_registers(0x4a0, 0x4ef, 0x00);
    add_file_registers(0x520, 0x56f, 0x00);
...
P16LF1938::P16LF1938(const char *_name, const char *desc)
    : P16F1938(_name, desc)
{
}
...
Processor * P16LF1938::construct(const char *name)
{
    P16LF1938 *p = new P16LF1938(name);
    p->set_Vdd(3.3);		//set before create
    p->create(0x7f, 256, 0x24A0);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
void  P16LF1938::create(int ram_top, int eeprom_size, int dev_id)
{
    P16F1938::create(ram_top, eeprom_size, dev_id);
}
//========================================================================
Processor * P16F1939::construct(const char *name)
{
    P16F1939 *p = new P16F1939(name);
    p->create(0x7f, 256, 0x23c0);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
P16F1939::P16F1939(const char *_name, const char *desc)
  : P16F1937(_name, desc)
{
}
...
void P16F1939::create(int ram_top, int eeprom_size, int dev_id)
{
    P16F1937::create(ram_top, eeprom_size, dev_id);
    ...
    add_file_registers(0x5a0, 0x5ef, 0x00);
    add_file_registers(0x620, 0x64f, 0x00);
    cpscon0.mValidBits = 0xCF;
}

P16LF1939::P16LF1939(const char *_name, const char *desc)
    : P16F1939(_name, desc)
{
}
...
Processor * P16LF1939::construct(const char *name)
{
    P16LF1939 *p = new P16LF1939(name);
    p->set_Vdd(3.3);		//set before create
    p->create(0x7f, 256, 0x24c0);
    p->create_invalid_registers();
    p->create_symbols();
    return p;
}
...
void  P16LF1939::create(int ram_top, int eeprom_size, int dev_id)
{
    P16F1939::create(ram_top, eeprom_size, dev_id);
}
