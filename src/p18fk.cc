...
void P18F14K22::create_sfr_map()
{
    ...
    add_sfr_register(sr_latch.srcon0, 0xf68, porv);
    add_sfr_register(sr_latch.srcon1, 0xf69, porv);
    ...
    sr_latch.setPins(&(*m_portb)[0], &(*m_porta)[2], &(*m_portc)[4]);
...
P18F26K22::P18F26K22(const char *_name, const char *desc)
    : _16bit_processor(_name, desc),
      ...
      ssp2(this),
      ctmu(this),
      hlvdcon(this, "hlvdcon", "High/Low-Voltage Detect Register", hlvd_volts, 1.024),
      osccon2(this, "osccon2", "Oscillator Control Register 2"),
...
//  add_sfr_register(osccon,     0xfd3, RegisterValue(0x30,0), "osccon");
    ...
    add_sfr_register(sr_latch.srcon0, 0xf47, porv);
    add_sfr_register(sr_latch.srcon1, 0xf46, porv);
...
const double P18F26K22::hlvd_volts[15] = { 
    1.84, 2.07, 2.28, 2.44, 2.54, 2.74, 2.87, 3.01,
