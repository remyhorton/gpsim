...
void P16F88x::create_sfr_map()
{
    ...
    sr_latch.srcon0 = (SRCON0 *)new SRCON0_V3(this, "srcon", "SR Latch Control Register", &sr_latch);
    add_sfr_register(sr_latch.srcon0, 0x185, RegisterValue(0, 0), "srcon");
    ...
    sr_latch.setPins(nullptr, &(*m_porta)[4], &(*m_porta)[5]);
