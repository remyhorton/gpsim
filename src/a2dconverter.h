...
public:
    ...
    int getChannelNumber(PinModule *);
...
public:
    ...
    void setAdcon1(ADCON1 *new_adcon1, PortRegister *_m_port = nullptr);
    void setAnsel(ANSEL_P *new_ansel);
    void setPort(PortRegister *_m_port) {m_port = _m_port;}
    void put(unsigned int new_val) override;
    void setValidBits(unsigned int mask) { valid_bits = mask; }
