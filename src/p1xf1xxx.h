...
public:
    ...
    static Processor *construct(const char *name);
    virtual void create(int ram_top, int ee_size, int dev_id);
    virtual void create_iopin_map();
    void create_sfr_map() override;
};
...
{
public:
   P16F1847(const char *_name = nullptr, const char *desc = nullptr);
   ~P16F1847();
   ...
   void set_out_of_range_pm(unsigned int address, unsigned int value) override;
   void oscillator_select(unsigned int mode, bool clkout) override;
   PROCESSOR_TYPE isa() override { return _P16F1847_; }
...
class P16LF1847 : public P16F1847
{
public:
    P16LF1847(const char *_name = nullptr, const char *desc = nullptr);
    ~P16LF1847();

    static Processor *construct(const char *name);
    void create(int ram_top, int eeprom_size, int dev_id) override;
    PROCESSOR_TYPE isa() override { return _P16LF1847_; }
};


class P16F193x : public _14bit_e_processor
{
public:
   P16F193x(const char *_name = nullptr, const char *desc = nullptr);
   ~P16F193x();

   void create_sfr_map() override;
   void oscillator_select(unsigned int mode, bool clkout) override;
    void option_new_bits_6_7(unsigned int bits) override;
    void set_out_of_range_pm(unsigned int address, unsigned int value);
    ...
    // not 28pin varients ANSEL_P 	        ansele;
    WPU 	       *m_wpue;
    ...
    virtual PIR *get_pir1() { return pir1; }
    virtual PIR *get_pir2() { return pir2; }
    virtual PIR *get_pir3() { return pir3; }
    virtual PIR_SET *get_pir_set() { return &pir_set_2_def; }
    EEPROM_EXTND *get_eeprom() override { return (EEPROM_EXTND *)eeprom; }
    void program_memory_wp(unsigned int mode) override;
};
class P16F1933 : public P16F193x
{
public:
   P16F1933(const char *_name = nullptr, const char *desc = nullptr);
   ~P16F1933();

   static Processor *construct(const char *name);
   unsigned int program_memory_size() const override { return 4 * 1024; }
   void create(int ram_top, int eeprom_size, int dev_id);
   void create_sfr_map() override;
   virtual void create_iopin_map();
    unsigned int register_memory_size() const override { return 0x1000; }
    void option_new_bits_6_7(unsigned int bits) override;
   PROCESSOR_TYPE isa() override { return _P16F1933_; }
};
class P16LF1933 : public P16F1933
{
public:
    P16LF1933(const char *_name = nullptr, const char *desc = nullptr);
    ~P16LF1933();

    PROCESSOR_TYPE isa() override { return _P16LF1933_; }
...
class P16F1934 : public P16F1933
{
public:
   P16F1934(const char *_name = nullptr, const char *desc = nullptr);
   ~P16F1934();
   ...
   virtual void create_iopin_map();
    unsigned int register_memory_size() const override { return 0x1000; }
    void option_new_bits_6_7(unsigned int bits) override;
   PROCESSOR_TYPE isa() override { return _P16F1934_; }
    ANSEL_P 	        anseld;
    ANSEL_P 	        ansele;
...
class P16LF1934 : public P16F1934
{
public:
    P16LF1934(const char *_name = nullptr, const char *desc = nullptr);
    ~P16LF1934();

    PROCESSOR_TYPE isa() override { return _P16LF1934_; }
...
class P16F1936 : public P16F1933
{
public:
    P16F1936(const char *_name = nullptr, const char *desc = nullptr);
    ~P16F1936();

   unsigned int program_memory_size() const override { return 8 * 1024; }
    PROCESSOR_TYPE isa() override { return _P16F1936_; }
...
class P16LF1936 : public P16F1936
{
public:
    P16LF1936(const char *_name = nullptr, const char *desc = nullptr);
    ~P16LF1936();

    PROCESSOR_TYPE isa() override { return _P16LF1936_; }
...
class P16F1937 : public P16F1934
{
public:
   P16F1937(const char *_name = nullptr, const char *desc = nullptr);
   ~P16F1937();

   static Processor *construct(const char *name);
   unsigned int program_memory_size() const override { return 8 * 1024; }
   void create(int ram_top, int eeprom_size, int dev_id);
   PROCESSOR_TYPE isa() override { return _P16F1937_; }
};
class P16LF1937 : public P16F1937
{
public:
    P16LF1937(const char *_name = nullptr, const char *desc = nullptr);
    ~P16LF1937();

    PROCESSOR_TYPE isa() override { return _P16LF1937_; }
...
class P16F1938 : public P16F1933
{
public:
    P16F1938(const char *_name = nullptr, const char *desc = nullptr);
    ~P16F1938();

    unsigned int program_memory_size() const override { return 16 * 1024; }
    PROCESSOR_TYPE isa() override { return _P16F1938_; }
...
class P16LF1938 : public P16F1938
{
public:
    P16LF1938(const char *_name = nullptr, const char *desc = nullptr);
    ~P16LF1938();

    PROCESSOR_TYPE isa() override { return _P16LF1938_; }
...
class P16F1939 : public P16F1937
{
public:
   P16F1939(const char *_name = nullptr, const char *desc = nullptr);
   ~P16F1939();

   static Processor *construct(const char *name);
   unsigned int program_memory_size() const override { return 16 * 1024; }
   void create(int ram_top, int eeprom_size, int dev_id);
   PROCESSOR_TYPE isa() override { return _P16F1939_; }
};
class P16LF1939 : public P16F1939
{
public:
    P16LF1939(const char *_name = nullptr, const char *desc = nullptr);
    ~P16LF1939();

    PROCESSOR_TYPE isa() override { return _P16LF1939_; }
