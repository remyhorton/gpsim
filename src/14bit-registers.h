...
public:
    ...
    OSCCAL(Processor *_pCpu, const char *pName, const char *pDesc, unsigned int bitMask)
        : sfr_register(_pCpu, pName, pDesc)
    {
...
public:
    ...
    void calculate_freq();
    void set_pin(unsigned int _chan, PinModule *_pin);
...
public:
    ...
    SRCON0(Processor *pCpu, const char *pName, const char *pDesc, SR_LATCH *_sr_latch);
    void put(unsigned int new_value) override;
...
public:
    ...
    SRCON0_V2(Processor *pCpu, const char *pName, const char *pDesc, SR_LATCH *_sr_latch);
    void put(unsigned int new_value) override;
    void set_ValidBits(unsigned int validbits) { mValidBits = validbits; }
...
public:
    ...
    SRCON0_V3(Processor *pCpu, const char *pName, const char *pDesc, SR_LATCH *_sr_latch);
    void put(unsigned int new_value) override;
    void set_ValidBits(unsigned int validbits) { mValidBits = validbits; }
...
public:
    ...
    SRCON1(Processor *pCpu, const char *pName, const char *pDesc, SR_LATCH *m_sr_latch);
    void put(unsigned int new_value) override;
    void set_ValidBits(unsigned int validbits) { mValidBits = validbits; }
...
public:
    ...
    SRCON1_V2(Processor *pCpu, const char *pName, const char *pDesc, SR_LATCH *m_sr_latch);
    void put(unsigned int new_value) override;
    void set_ValidBits(unsigned int validbits) { mValidBits = validbits; }
...
class SR_LATCH : public TriggerObject, public apfpin
{
public:
    explicit SR_LATCH(Processor *);
    ~SR_LATCH();
