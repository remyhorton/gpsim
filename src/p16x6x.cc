      ...
      int_pin(this, &intcon_reg, 0)
{
    ...
    tmr0.set_tmr0_cpu(this, &porta, 4, option_reg);
    tmr0.start(0);
...
void P16F610::create_sfr_map()
{
    ...
    sr_latch.srcon0 = (SRCON0 *)new SRCON0_V2(this, "srcon0", "SR Latch Control 0 Register", &sr_latch);
    sr_latch.srcon1 = (SRCON1 *)new SRCON1_V2(this, "srcon1", "SR Latch Control 1 Register", &sr_latch);
    add_sfr_register(sr_latch.srcon0, 0x99, RegisterValue(0x00, 0));
    add_sfr_register(sr_latch.srcon1, 0x9a, RegisterValue(0x00, 0));
    ...
    sr_latch.setPins(nullptr, &porta[2], &portc[4]);
}
