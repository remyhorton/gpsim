...
;
 ...
 bsf    COG1CON0,G1EN       ; Enable the COG
  .assert "ErrorBits1 == 0, '*** FAILED p16f1709 ASE settable without COGEN'"
 ...
 btfsc  PORTA,5
 bsf    ErrorBits1,1
  .assert "ErrorBits1 == 0, '*** FAILED p16f1709 ASE forces outputs low'"
 ...
 btfsc  PORTA,5
 bsf    ErrorBits1,2
  .assert "ErrorBits1 == 0, '*** FAILED p16f1709 rising edge with ASE'"
 ...
 btfsc  PORTA,5
 bsf    ErrorBits1,3
  .assert "ErrorBits1 == 0, '*** FAILED p16f1709 falling edge with ASE'"
 ...
 bsf    ErrorBits1,4
  .assert "ErrorBits1 == 0, '*** FAILED p16f1709 clear ASE flag'"

 banksel PORTA
 btfss  PORTA,4
 btfsc  PORTA,5
 bsf    ErrorBits1,5
  .assert "ErrorBits1 == 0, '*** FAILED p16f1709 clear ASE wait for edge'"
 ...
 btfsc  PORTA,5
 bsf    ErrorBits1,6
  .assert "ErrorBits1 == 0, '*** FAILED p16f1709 outputs enabled on rising edge'"
 ...
 btfss  PORTA,5
 bsf    ErrorBits1,7
  .assert "ErrorBits1 == 0, '*** FAILED p16f1709 outputs on falling edge'"
...
;
	...
	bsf     DRV_CLOCK
	nop
  .assert "((porta&0x33)==0x11), '*** FAILED p16f1709 rising deadband double buffer'"
	movf    PORTA,w
	andlw   0x33
	xorlw   0x11
	skpz
	...
	bcf     DRV_CLOCK
	nop
  .assert "((porta&0x33)==0x22), '*** FAILED p16f1709 falling deadband double buffer'"
	movf    PORTA,w
	andlw   0x33
	xorlw   0x22
	skpz
	...
	bsf     COG1CON0,G1LD
	nop
  .assert "((cog1con0&0x40)==0x40), '*** FAILED p16f1709 set GxLD bit'"
	btfss   COG1CON0,G1LD
	bsf     ErrorBits2,2
	...
	bsf     DRV_CLOCK
	nop
  .assert "((porta&0x33)==0x00), '*** FAILED p16f1709 rising deadband delay'"
	movf    PORTA,w
	andlw   0x33
	skpz
	bsf     ErrorBits2,4
	nop
  .assert "((porta&0x33)==0x11), '*** FAILED p16f1709 rising deadband expiry'"
	movf    PORTA,w
	andlw   0x33
	xorlw   0x11
	skpz
	...
	nop
	nop
  .assert "((porta&0x33)==0x00), '*** FAILED p16f1709 falling deadband delay'"
	movf    PORTA,w
	andlw   0x33
	skpz
	bsf     ErrorBits2,6
	nop
  .assert "((porta&0x33)==0x22), '*** FAILED p16f1709 falling deadband expiry'"
	movf    PORTA,w
	andlw   0x33
	xorlw   0x22
	skpz
	...
	banksel COG1CON0
  .assert "((cog1con0&0x40)==0x00), '*** FAILED p16f1709 GxLD bit self-clear'"
	btfsc   COG1CON0,G1LD
	bsf     ErrorBits2,3
